...
{
    [HtmlTargetElement("div", Attributes="products")] /*hangi element ve hangi attribute. Footera bak*/
    public class LastestProductTagHelper : TagHelper
    {
        ...
        {
            TagBuilder div = new TagBuilder("div");/*TagBuilder ile Html etiketi insa ediyoruz.*/
            ...
            var products = _serviceManager.ProductService.GetLastestProducts(5, false);
